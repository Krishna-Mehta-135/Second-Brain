...
import {Brain, FileText, Link2, Search, Tags, Share2, ArrowRight, Sparkles} from "lucide-react";
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-gray-900 dark:to-slate-800 transition-all duration-500">
            ...
            <header className="relative z-10 p-6 flex justify-between items-center backdrop-blur-sm">
                ...
                <div className="flex items-center gap-4">
                    <ThemeToggle />
                    <Button size="md" variant="Secondary" text="Sign In" onClick={() => router.push("/signin")} />
                    <Button size="md" variant="Primary" text="Get Started" onClick={() => router.push("/signup")} />
                </div>
            </header>
