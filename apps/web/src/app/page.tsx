...
export default function Homepage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-gray-900 dark:to-slate-800 transition-all duration-500">
      ...
      <main className="relative px-6 py-20 text-center">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-12 leading-relaxed">
            Capture knowledge from anywhere. Organize it intelligently. Access
            it instantly. Transform scattered information into structured
            wisdom.
          </p>
      ...
      <section
        id="how-it-works"
        className="py-24 px-6 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm"
      >
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Three simple steps to transform scattered information into
              organized knowledge
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                Drop any link, tweet, or article. Our smart system automatically
                categorizes and extracts key information.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                Tag your content, create categories, and build connections. Let
                your knowledge graph grow organically.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                Find what you need instantly with powerful search. Share your
                curated collections with others.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-200/50 dark:border-gray-700/50">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                Automatically organize content by type and topic. Never lose
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-200/50 dark:border-gray-700/50">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                Find any piece of content in seconds with our powerful search
                that understands context and tags.
              </p>
            </div>
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-200/50 dark:border-gray-700/50">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                Share your knowledge collections with teams, friends, or the
                public with secure sharing links.
              </p>
            </div>
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-200/50 dark:border-gray-700/50">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                Create and manage tags on the fly. Build your own taxonomy that
                evolves with your knowledge.
              </p>
            </div>
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-200/50 dark:border-gray-700/50">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                Save tweets, YouTube videos, articles, PDFs, and any web content
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-200/50 dark:border-gray-700/50">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                ...
                learning, not on managing tools.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 px-6 bg-gradient-to-r from-purple-600 to-blue-600 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <p className="text-xl text-purple-100 mb-8 max-w-2xl mx-auto leading-relaxed">
            Join thousands of knowledge workers, students, and creators who have
            transformed how they capture and organize information.
          </p>
      ...
      <footer className="p-8 text-center bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm border-t border-gray-200/50 dark:border-gray-700/50">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-sm">
            Made for knowledge enthusiasts • © {new Date().getFullYear()} Second
            Brain
          </p>
        </div>
      </footer>
